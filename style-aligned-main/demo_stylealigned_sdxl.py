...
pipeline = StableDiffusionXLPipeline.from_pretrained(
    r"C:/Users/Admin/.cache/modelscope/hub/AI-ModelScope/stable-diffusion-xl-base-1.0", torch_dtype=torch.float16, variant="fp16", use_safetensors=True,
    scheduler=scheduler
).to("cuda")
...
def style_aligned_sdxl(initial_prompt1, initial_prompt2, initial_prompt3, initial_prompt4,
    ...
    try:
        ...
        #
        sets_of_prompts = [prompt for prompt in[initial_prompt1, initial_prompt2, initial_prompt3, initial_prompt4, initial_prompt5] if prompt]
